...
const AdminUsers = () => {
  ...
  return (
    <div className="font-raleway flex flex-col gap-y-[2rem] lg:w-[80%] w-[100%] lg:py-[2rem] pt-[4rem] 2xl:py-[4rem]">
      <div className="bg-adminBg rounded-3xl pb-[1rem] overflow-hidden">
        <div className="font-lato flex items-start lg:gap-x-[.8rem] gap-x-0 lg:static relative">
          {/* Menu Icon for small screen */}
          <div
            className="text-primary_blue text-xl cursor-pointer lg:hidden block px-[1rem] py-[1.64rem] bg-[#131313] absolute sm:right-10 right-0"
          ...
          {/* My Chats */}
          <div
            className={`lg:w-[30%] sm:w-[60%] w-[80%] lg:pl-[2rem] lg:pt-[1rem] lg:p-0 p-6 lg:bg-transparent bg-white lg:h-auto max-h-screen overflow-y-scroll lg:rounded-none rounded-md lg:shadow-none shadow-xl lg:static absolute top-20 right-0 lg:flex ${
              open ? "block" : "hidden"
            } flex-col sm:gap-y-[.5rem] gap-y-[2rem]`}
          >
            <h3 className="font-[500] text-[1.5rem]">My Chats</h3>
            <ul className="flex flex-col gap-y-[.5rem]">
              {[1, 2, 3, 4].map((item, i) => (
                ...
                >
                  ...
                  >
                    <div className="flex items-center lg:gap-x-[.8rem] gap-x-[.3rem]">
                      <div
                        className={`image ${
                          active === i ? "bg-white" : "bg-[#2D2D2D]"
                        } rounded-full p-2 w-[50px]`}
                      >
                        <img
                          src="/images/userchat.png"
                          className="lg:max-w-[full]  object-cover "
                          alt="user"
                        />
                      </div>
                  ...
                  <div className="other_user flex items-start justify-end sm:max-w-[70%] max-w-[80%] sm:ml-[30%] ml-[20%] gap-x-[.5rem]">
                    <div className="bg-[#131313] text-white rounded-r-3xl rounded-bl-3xl sm:px-[1.5rem] px-[1rem] sm:py-[1rem] py-[.5rem] shadow-lg">
                      <p className="sm:text-base text-sm">
                        ...
                        facilisi.Lorem ipsum dolor sit amet, consectetur
                        adipiscing elit.
                      </p>
                    </div>
                    <div className="profile_img bg-primary_blue p-1 rounded-full">
